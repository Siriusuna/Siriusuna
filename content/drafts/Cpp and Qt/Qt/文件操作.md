# `QFile`
![](IMG-20251214140712371.png)

Example:
![](IMG-20251214140712448.png)
别忘了 close

![](IMG-20251214140712694.png)

# `QTextStream`
![](IMG-20251214140712899.png)
```cpp
in.setEncoding(QStringConverter::Utf8); // Qt6
```

![](IMG-20251214140713045.png)

# `QFileDialog`
![](IMG-20251214140713188.png)
```cpp
fileName = QFileDialog::getOpenFileName(this,
    tr("Open Image"), "/home/jana", tr("Image Files (*.png *.jpg *.bmp)"));
```
分步自定义与打开：
![](IMG-20251214140713275.png)
```cpp
// 1. 创建一个文件对话框对象
...
# 文件编码
![](IMG-20251214140713498.png)
![](IMG-20251214140713604.png)
![](IMG-20251214140713698.png)
![](IMG-20251214140713833.png)

# 光标位置
![](IMG-20251214140713915.png)
