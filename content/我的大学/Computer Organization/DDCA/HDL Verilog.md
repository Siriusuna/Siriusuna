...
![[IMG-20251214225103050.png]]
![[IMG-20251214225103077.png]]
### 模板
#### Moore
![[IMG-20251214225103105.png]]
### Mealy
![[IMG-20251214225103132.png]]

# Verilog数据类型
![[IMG-20251214225103167.png]]
![[IMG-20251214225103202.png]]
Verliog主要用两种类型：`reg`和`wire`  
与SystemVerilog有诸多不同
![[IMG-20251214225103240.png]]
> `reg`不一定和寄存器有关系
...
![[IMG-20251214225103293.png]]
关键字：`initial`，用于初始化时运行一次块中指令。***不可综合。***

## 自检测试程序
可以自动检查是否符合输出向量
![[IMG-20251214225103321.png]]
> `==` and `===`
![[IMG-20251214225103348.png]]

可以把测试向量卸载单独文件中，测试程序读取、输入、判断输出。
![[IMG-20251214225103378.png]]
