...
# The Root Route
![](IMG-20251214143651319.png)

# An Example
![](IMG-20251214143651365.png)
...
![](IMG-20251214143651393.png)
`as: xxx`  
Then xxx_path will be evaluated to a route that `:as`'s value is `xxx`.

![](IMG-20251214143651433.png)

# Summary

![](IMG-20251214143651466.png)

![](IMG-20251214143651490.png)

# Routes for Association
![](IMG-20251214143651521.png)

![](IMG-20251214143651554.png)
`movie_reviews_path(m)` in line 3

![](IMG-20251214143651586.png)
![](IMG-20251214143651619.png)
