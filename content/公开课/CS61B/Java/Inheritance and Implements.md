...
![](IMG-20251214141132279.png)

 A class or an interface can implements more than one interface.[Subtype Polymorphism](Subtype%20Polymorphism.md)  
...
> ([Covariant return types](Type%20Checking%20and%20Casting.md#^hln5l8.md))
```java
class Parent { 
...
In other words, at compile - time, it ["follows the contract of the parent class"](Type%20Checking%20and%20Casting.md).
...
![](IMG-20251214141132520.png)

# Dynamic Method Selection
![](IMG-20251214141132562.png)
...
![](IMG-20251214141132590.png)

![](IMG-20251214141132618.png)
...
[Encapsulation](Encapsulation.md), [Type Checking and Casting](Type%20Checking%20and%20Casting.md) are also related to this notes.
![](IMG-20251214141132647.png)

![](IMG-20251214141132674.png)
