[visualize here!](http://goo.gl/HLzN6s)

# Basic Rules
1. Java is an [OOP](Object-Oriented%20Programming(OOP).md) program language.All code in Java must be part of a class.
...
6. Java variables must have a specific [type](公开课/CS61B/Java/Types.md).
7. Java variable types can never change.
8. Java needs [compiling](Compile.md) so types are verified before the code even runs!
